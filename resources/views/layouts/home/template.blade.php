...
<!-- Morris.js charts -->
    ...
    <body>
        ...
        @include('layouts.home.side')
			...
			<!-- Page Wrapper -->
            <div class="page-wrapper" style="@php if($ttl=='HomePage') echo 'margin-left: auto;'; @endphp">
		...
		<!-- jQuery -->
		  @stack('scripts')
		   <script src="{{asset('mynew/myfiles/js/jquery.min.js')}}"></script>
		@yield('extrajs')
